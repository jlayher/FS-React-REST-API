...
//handleSubmit function (axios PUT request)
    //bind to "this" in constructor
    //take in event object as parameter

//use the state from the axios request to fill in data for:
//     course title, 
//     author, 
//     description, 
//     estimated time,
...
export default props => (
    <Consumer>
        {context => <UpdateCourse {...props} value={context} />}
    </Consumer>
)
